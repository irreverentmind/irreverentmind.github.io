...
// Javascript for stacks_in_126_page18
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_126_page18 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_126_page18 = (function(stack) {
...
// Javascript for stacks_in_3505_page18
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_3505_page18 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_3505_page18 = (function(stack) {
 ...
 var opacity=95,opacityBottom=85,hoverOpacity=50,subNavIndex=1,divide=1,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='centered',baseColor='#E6E6E6',baseColorTop='#737373',activeColor='#333333',hoverColor='#0080FF',styleActive='styleActive'==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_3505_page18 ul:not(.title-area) li:hover > a:not(.button)',dropdowns='#stacks_in_3505_page18 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],preset:style,gradient:'linear',opacity:[opacity,opacityBottom],selector:'#stacks_in_3505_page18 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_3505_page18 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_3505_page18 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_3505_page18 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[activeColor],opacity:[hoverOpacity],selector:active});}
...
$(document).ready(function(){var stack=$('#stacks_in_3505_page18');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
...
// Javascript for stacks_in_7007_page18
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7007_page18 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7007_page18 = (function(stack) {
 ...
 $(document).ready(function(){var stack=$('#stacks_in_7007_page18');$('.breadcrumbs li',stack).last().addClass('current');$('.breadcrumbs a header',stack).unwrap().parent().addClass('unavailable');});
